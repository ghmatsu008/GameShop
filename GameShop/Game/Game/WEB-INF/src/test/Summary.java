	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			while(rs.next()){
				...
				out.println("<td align=\"center\" class=\"woong\">"+a+"</td>");
				out.println("<td align=\"center\" bgcolor=\"#FFFFFF\">");
				out.println("<a href=\"http://localhost:8080/GameShop/Detail?id="+j+"\">");
				out.println("<img src=\"imeg/ps4 (1).jpg\"\" border=\"0\"  width=50  align=\"center\" valign=\"absmiddle\" alt=\"\"></a></td>");
				out.println("<td><a href=\"http://localhost:8080/GameShop/Detail?id="+j+"\">");
				out.println("<u>"+rs.getString("nam")+"</a> <imeg align=\"absmiddle\" border=\"0\"></u>");
				out.println("</td><td align=\"center\">"+rs.getInt("id_Category")+"</td>");
				out.println("<td align=\"center\"><font color=\"#F15800\"><b>"+rs.getInt("price")+"円</b></font></td></tr>");
