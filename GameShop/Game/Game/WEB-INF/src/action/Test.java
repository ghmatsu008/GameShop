...
//			    query.append(" OR 所属=").append(key.get(i));
			...
			sql = "SELECT * FROM product2 LIMIT " + n + "," + c;
		...
		session.setAttribute("pageA", (n));
		session.setAttribute("pageB", (c));
...
//			System.out.println(i);
		...
		out.println("<p class=\"next\"><a href=\"http://localhost:8080/GameShop/Test3?id="+(pageNo+1)+"\">次へ</a></p>");
		out.println("</p></div>");
